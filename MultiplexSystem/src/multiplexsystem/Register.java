...
public class Register extends javax.swing.JFrame {
    ...
    public boolean check(String email1){
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Fill The Following details:");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(name)
                            .addComponent(email)
                            .addComponent(num, javax.swing.GroupLayout.DEFAULT_SIZE, 300, Short.MAX_VALUE)
                            .addComponent(pass)))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(160, 160, 160)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(!checkm(num.getText())){
        
          error.setText("invalid Mobile No.");
          clear();
           return;       
        ...
        Connection con=Authentication.CustomerConn();
           try{  
            ...
            stmt.executeUpdate("insert into customer values(\'"+email.getText()+"\',\'"+name.getText()+"\',\'"+num.getText()+"\',\'"+pass.getText()+"\');");
             con.close();
      }
           catch(Exception e){
